        ...
        <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#flight">Today's Space</a>

            </div>
          </div>
          <p class="text-secondary">Today's Space</p>
            ...
            <table>
              ...
              <?php foreach ($cars as $car): ?>
                <tr>
                  ...
                  <td>
                    <?php echo $car['owner_name']; ?>
                  </td>
                  <td>
                    <?php echo $car['licences_number']; ?>
                  </td>
                  <td>
                    <?php echo $car['car_brand']; ?>
                  </td>
                  <td>
                    <?php echo $car['check_in_time']; ?>
                  </td>
                  <td>
                    <?php echo $car['check_out_time']; ?>
                  </td>
                  <td>
                    <?php echo $car['passengers']; ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </table>
