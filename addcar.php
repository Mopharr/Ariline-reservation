                    ...
                    <form action="book_flight.php" method="post">
                        ...
                        <div class="date">
                            <div class="depart">
                                ...
                                <input class="form-control" name="dep_date" type="time" onfocus="this.value = '';"
                                    onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
                            </div>
                            <div class="return">
                                <h3 style="color: rgba(255, 255, 255, 0.767);">Check Out time</h3>
                                <input class="form-control" name="ret_date" type="time" onfocus="this.value = '';"
                                    onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
                            </div>
                            <div class="clear"></div>
                        </div>
...
<footer class="mt-5">
    ...
    <div class="text-light text-center">&copy;
        <?php echo date('Y') ?> - Developed By Shitta<br><br>
    </div>
    <!-- <p>----------</p> -->
